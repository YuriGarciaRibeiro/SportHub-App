...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final _viewModel = LoginScreenViewModel();
  ...
  Future<void> _handleLogin() async {
    ...
    if (mounted) {
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_viewModel.errorMessage ?? 'Erro no login'),
          ...
          child: Column(
            ...
            children: [
              ...
              Form(
                ...
                child: Column(
                  children: [
                    EmailFormField(emailController: _viewModel.emailController),

                    SizedBox(height: 1.8.h),

                    PasswordFormField(viewModel: _viewModel),
